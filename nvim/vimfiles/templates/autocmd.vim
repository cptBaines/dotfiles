...
autocmd BufNewFile *.h set fileencoding=utf8
autocmd BufNewFile *.c exec "so ". g:myvimconfig ."/make.vim"
autocmd BufEnter   *.h set filetype=h
autocmd BufEnter   *.h set fileencoding=utf8
autocmd BufEnter   *.h exec "so ". g:myvimconfig ."/make.vim"
...
autocmd BufNewFile *.c set fileencoding=utf8
autocmd BufNewFile *.c exec "so ". g:myvimconfig ."/make.vim"
autocmd BufEnter   *.c set filetype=c
autocmd BufEnter   *.c set fileencoding=utf8
autocmd BufEnter   *.c exec "so ". g:myvimconfig ."/make.vim"
